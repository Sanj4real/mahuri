<!-- products -->
<section class="products spacing" id="end">
    <div class="container">
        <div class="site-header">
            <h5><?php echo $title ?></h5>
            <a href="lisiting.php">See all ></a>
        </div>
        <div class="row rm-disc row-cols-lg-4 row-cols-xl-5 row-cols-md-3 row-col-sm-1">
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-1.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-5.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-6.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-7.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-8.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-9.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-13.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-10.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-11.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
            ...
            <div class="product-wrap">
                <div class="product-block">
                    <div class="product__img">
                        <a href="detail.php">
                            <img src="img/product/n-12.jpg" alt="">
                            <div class="side-hov">
                                <ul>
                                    <li>
                                        <a href="leave.php">
