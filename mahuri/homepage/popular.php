<section class="products spacing">
    <div class="container">
        <div class="row ">
            <div class="col-sm-12 col-md-5 col-lg-3">
                <div class="product__popular">
                    ...
                    <div class="">
                        <a href="detail.php" class="site-button">Enter Shop <i class="las la-arrow-right"></i></a>
                    </div>
                    <div class="quick">
                        <h6>Quick View</h6>
                        <ul class="nav nav-pills " id="pills-tab" role="tablist">
                            <li role="presentation">
                                <button class=" active" id="quick-one" data-bs-toggle="pill" data-bs-target="#quick-1"
                                    type="button" role="tab" aria-controls="quick-1"
                                    aria-selected="true">Phones</button>
                            </li>
                            <li role="presentation">
                                <button class="" id="quick-two" data-bs-toggle="pill" data-bs-target="#quick-2"
                                    type="button" role="tab" aria-controls="quick-2"
                                    aria-selected="false">Laptops</button>
                            </li>
                            <li role="presentation">
                                <button class="" id="quick-three" data-bs-toggle="pill" data-bs-target="#quick-3"
                                    type="button" role="tab" aria-controls="quick-3" aria-selected="false">Toys</button>
                            </li>
                            <li role="presentation">
                                <button class="" id="quick-four" data-bs-toggle="pill" data-bs-target="#quick-4"
                                    type="button" role="tab" aria-controls="quick-4" aria-selected="false">Tv</button>
                            </li>
                            <li role="presentation">
                                <button class="" id="quick-five" data-bs-toggle="pill" data-bs-target="#quick-5"
                                    type="button" role="tab" aria-controls="quick-5"
                                    aria-selected="false">fashion</button>
                            </li>
                            <li role="presentation">
                                <button class="" id="quick-six" data-bs-toggle="pill" data-bs-target="#quick-6"
                                    type="button" role="tab" aria-controls="quick-6"
                                    aria-selected="false">automobile</button>
                            </li>
                            <li role="presentation">
                                <button class="" id="quick-seven" data-bs-toggle="pill" data-bs-target="#quick-7"
                                    type="button" role="tab" aria-controls="quick-7"
            ...
            <div class="col-sm-12 col-md-7 col-lg-9">
                <div class="tab-content mobile" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="quick-1" role="tabpanel" aria-labelledby="quick-one">
                        <div class="products-slider owl-carousel br-rm">
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            <img src="img/product/p-4.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                            ...
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            <img src="img/product/p-5.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                            ...
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            <img src="img/product/p-6.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                            ...
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            <img src="img/product/p-8.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                            ...
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            <img src="img/product/p-9.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                            ...
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            <img src="img/product/p-10.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                    ...
                    <div class="tab-pane fade show " id="quick-2" role="tabpanel" aria-labelledby="quick-two">
                                ...
                                <div class="product-block">
                                    <div class="product__img">
                                        <a href="detail.php">
                                            ...
                                            <div class="trend">
                                                <h6>Trending</h6>
                                            </div> <img src="img/product/p-2.webp" alt="">
                                            <div class="side-hov">
                                                <ul>
                                                    <li>
                                                        <a href="leave.php">
                    ...
                    <div class="tab-pane fade show " id="quick-3" role="tabpanel" aria-labelledby="quick-three">
                        <div class="products-slider owl-carousel">
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                    ...
                    <div class="tab-pane fade show " id="quick-4" role="tabpanel" aria-labelledby="quick-four">
                        <div class="products-slider owl-carousel">
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                    ...
                    <div class="tab-pane fade show " id="quick-5" role="tabpanel" aria-labelledby="quick-five">
                        <div class="products-slider owl-carousel">
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                    ...
                    <div class="tab-pane fade show " id="quick-6" role="tabpanel" aria-labelledby="quick-six">
                        <div class="products-slider owl-carousel">
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
                    ...
                    <div class="tab-pane fade show " id="quick-7" role="tabpanel" aria-labelledby="quick-seven">
                        <div class="products-slider owl-carousel">
                            <div class="product-wrap">
                                <div class="product-block">
                                    <div class="product__img">
